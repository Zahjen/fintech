<?php
    ...
    require '../modele/managers/ClientManager.php';
    require '../modele/objets/Client.php';
    ...
    // http://http://127.0.0.1/dashboard/Fintech/api/client.php
    // Il vient que url[4] = client.php
    ...
    // En instanciant la classe ClientController, et selon la requête, on executera la requête demandée
    $client_controller = new ClientController($bdd, $request_method, $id_client);
    $client_controller->execute_query();
