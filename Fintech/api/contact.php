<?php
    ...
    require '../controller/contact-controller.php';
    require '../modele/managers/ContactManager.php';
    require '../modele/objets/Contact.php';
    ...
    // http://http://127.0.0.1/dashboard/Fintech/api/contact.php
    // Il vient que url[4] = contact.php
