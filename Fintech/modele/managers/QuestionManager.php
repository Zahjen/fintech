    ...
    class QuestionManager {
        ...
        public function getById($idQuestion) {
            ...
            try{
                ...
                $req = $this->bdd->prepare('SELECT idQuestion, labelQuestion, type FROM question WHERE idQuestion = ?');
        ...
        public function getAll() {
            $listeQuestions = [];
            try{
                $req = $this->bdd->prepare( 'SELECT idQuestion, labelQuestion, type FROM question' );
                $req->execute();
        ...
        public function add(Question $question){
            try{
                $req = $this->bdd->prepare( 'INSERT INTO question(labelQuestion, type) VALUES(:labelQuestion, :type)' );
        ...
        public function update(Question $question){
            try{
                $req = $this->bdd->prepare('UPDATE question SET labelQuestion = :labelQuestion, type = :type WHERE idQuestion = :idQuestion');
